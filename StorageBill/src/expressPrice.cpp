...
void PrepareExpressPrice()
{
	...
	{
		//12公斤
		//g_chengBenZTKYPrice[L"吉林省"].push_back({ 0, 12, 12, 40, 0 });
		//g_chengBenZTKYPrice[L"辽宁省"].push_back({ 0, 12, 12, 40, 0 });
		//_chengBenZTKYPrice[L"黑龙江省"].push_back({ 0, 12, 12, 40, 0 });
		...
		//g_chengBenZTKYPrice[L"内蒙古自治区"].push_back({ 0, 12, 12, 45, 0 });
		//g_chengBenZTKYPrice[L"北京"].push_back({ 0, 12, 12, 25, 0 });
		...
		//g_chengBenZTKYPrice[L"宁夏回族自治区"].push_back({ 0, 12, 12, 45, 0 });
		//g_chengBenZTKYPrice[L"新疆维吾尔自治区"].push_back({ 0, 12, 12, 55, 0 });
		//g_chengBenZTKYPrice[L"甘肃省"].push_back({ 0, 12, 12, 45, 0 });
		...
		//g_chengBenZTKYPrice[L"凉山彝族自治州"].push_back({ 0, 12, 12, 29, 0 });
		...
		//g_chengBenZTKYPrice[L"攀枝花市"].push_back({ 0, 12, 12, 29, 0 });
		g_chengBenZTKYPrice[L"泸州市"].push_back({ 0, 12, 12, 16, 0 });
		//g_chengBenZTKYPrice[L"甘孜藏族自治州"].push_back({ 0, 12, 12, 29, 0 });
		...
		//g_chengBenZTKYPrice[L"阿坝藏族羌族自治州"].push_back({ 0, 12, 12, 29, 0 });
		g_chengBenZTKYPrice[L"雅安市"].push_back({ 0, 12, 12, 16, 0 });
		//g_chengBenZTKYPrice[L"西藏自治区"].push_back({ 0, 12, 12, 60, 0 });
		g_chengBenZTKYPrice[L"贵州省"].push_back({ 0, 12, 12, 16, 0 });
		g_chengBenZTKYPrice[L"重庆"].push_back({ 0, 12, 12, 16, 0 });
		//13-20公斤
		//g_chengBenZTKYPrice[L"吉林省"].push_back({ 12, 20, 20, 50, 0 });
		//g_chengBenZTKYPrice[L"辽宁省"].push_back({ 12, 20, 20, 50, 0 });
		//g_chengBenZTKYPrice[L"黑龙江省"].push_back({ 12, 20, 20, 50, 0 });
		...
		//g_chengBenZTKYPrice[L"内蒙古自治区"].push_back({ 12, 20, 20, 55, 0 });
		//g_chengBenZTKYPrice[L"北京"].push_back({ 12, 20, 20, 24, 0 });
		...
		//g_chengBenZTKYPrice[L"宁夏回族自治区"].push_back({ 12, 20, 20, 55, 0 });
		//g_chengBenZTKYPrice[L"新疆维吾尔自治区"].push_back({ 12, 20, 20, 60, 0 });
		//g_chengBenZTKYPrice[L"甘肃省"].push_back({ 12, 20, 20, 55, 0 });
		...
		//g_chengBenZTKYPrice[L"凉山彝族自治州"].push_back({ 12, 20, 20, 24, 0 });
		...
		//g_chengBenZTKYPrice[L"攀枝花市"].push_back({ 12, 20, 20, 35, 0 });
		g_chengBenZTKYPrice[L"泸州市"].push_back({ 12, 20, 20, 19, 0 });
		//g_chengBenZTKYPrice[L"甘孜藏族自治州"].push_back({ 12, 20, 20, 35, 0 });
		...
		//g_chengBenZTKYPrice[L"阿坝藏族羌族自治州"].push_back({ 12, 20, 20, 35, 0 });
		g_chengBenZTKYPrice[L"雅安市"].push_back({ 12, 20, 20, 19, 0 });
		//g_chengBenZTKYPrice[L"西藏自治区"].push_back({ 12, 20, 20, 70, 0 });
		g_chengBenZTKYPrice[L"贵州省"].push_back({ 12, 20, 20, 19, 0 });
		g_chengBenZTKYPrice[L"重庆"].push_back({ 12, 20, 20, 19, 0 });
		//20公斤以上
		//g_chengBenZTKYPrice[L"吉林省"].push_back({ 20, 0, 20, 50, 2.00 });
		//g_chengBenZTKYPrice[L"辽宁省"].push_back({ 20, 0, 20, 50, 2.00 });
		//g_chengBenZTKYPrice[L"黑龙江省"].push_back({ 20, 0, 20, 50, 2.00 });
		g_chengBenZTKYPrice[L"河南省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"湖北省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"湖南省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"上海"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"安徽省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"山东省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"江苏省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"江西省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"浙江省"].push_back({ 20, 0, 20, 24, 1.20 });
		//g_chengBenZTKYPrice[L"内蒙古自治区"].push_back({ 20, 0, 20, 55, 1.80 });
		//g_chengBenZTKYPrice[L"北京"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"天津"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"山西省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"河北省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"广西壮族自治区"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"广东省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"福建省"].push_back({ 20, 0, 20, 24, 1.20 });
		//g_chengBenZTKYPrice[L"宁夏回族自治区"].push_back({ 20, 0, 20, 55, 2.00 });
		//g_chengBenZTKYPrice[L"新疆维吾尔自治区"].push_back({ 20, 0, 20, 60, 2.90 });
		//g_chengBenZTKYPrice[L"甘肃省"].push_back({ 20, 0, 20, 55, 2.00 });
		g_chengBenZTKYPrice[L"陕西省"].push_back({ 20, 0, 20, 24, 1.20 });
		//g_chengBenZTKYPrice[L"青海省"].push_back({ 20, 0, 20, 55, 2.40 });
		g_chengBenZTKYPrice[L"云南省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"乐山市"].push_back({ 20, 0, 20, 24, 0.80 });
		g_chengBenZTKYPrice[L"内江市"].push_back({ 20, 0, 20, 24, 0.90 });
		//g_chengBenZTKYPrice[L"凉山彝族自治州"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"南充市"].push_back({ 20, 0, 20, 24, 0.80 });
		g_chengBenZTKYPrice[L"宜宾市"].push_back({ 20, 0, 20, 24, 0.90 });
		g_chengBenZTKYPrice[L"巴中市"].push_back({ 20, 0, 20, 24, 0.90 });
		g_chengBenZTKYPrice[L"广元市"].push_back({ 20, 0, 20, 24, 0.90 });
		g_chengBenZTKYPrice[L"广安市"].push_back({ 20, 0, 20, 24, 0.90 });
		g_chengBenZTKYPrice[L"德阳市"].push_back({ 20, 0, 20, 24, 0.80 });
		g_chengBenZTKYPrice[L"成都市"].push_back({ 20, 0, 20, 24, 0.70 });
		//g_chengBenZTKYPrice[L"攀枝花市"].push_back({ 20, 0, 20, 35, 1.20 });
		g_chengBenZTKYPrice[L"泸州市"].push_back({ 20, 0, 20, 24, 1.00 });
		//g_chengBenZTKYPrice[L"甘孜藏族自治州"].push_back({ 20, 0, 20, 35, 1.20 });
		g_chengBenZTKYPrice[L"眉山市"].push_back({ 20, 0, 20, 30, 0.80 });
		g_chengBenZTKYPrice[L"绵阳市"].push_back({ 20, 0, 20, 24, 0.80 });
		g_chengBenZTKYPrice[L"自贡市"].push_back({ 20, 0, 20, 24, 0.90 });
		g_chengBenZTKYPrice[L"资阳市"].push_back({ 20, 0, 20, 24, 0.80 });
		g_chengBenZTKYPrice[L"达州市"].push_back({ 20, 0, 20, 24, 1.00 });
		g_chengBenZTKYPrice[L"遂宁市"].push_back({ 20, 0, 20, 24, 0.80 });
		//g_chengBenZTKYPrice[L"阿坝藏族羌族自治州"].push_back({ 20, 0, 20, 35, 1.20 });
		g_chengBenZTKYPrice[L"雅安市"].push_back({ 20, 0, 20, 24, 0.90 });
		//g_chengBenZTKYPrice[L"西藏自治区"].push_back({ 20, 0, 20, 70, 2.80 });
		g_chengBenZTKYPrice[L"贵州省"].push_back({ 20, 0, 20, 24, 1.20 });
		g_chengBenZTKYPrice[L"重庆"].push_back({ 20, 0, 20, 24, 1.00 });
	}
	//永创耀辉中通快运
	{
		//12公斤
